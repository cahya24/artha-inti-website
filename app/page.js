    ...
    <div>
      ...
      <div className='h-36 overflow-hidden'>
        <svg
          ...
          <path fill="#0099ff" fill-opacity="1" d="M0,160L80,154.7C160,149,320,139,480,160C640,181,800,235,960,229.3C1120,224,1280,160,1360,128L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
        </svg>
      </div>
      <ContentBoxSection />
      <div className='h-36 overflow-hidden'>
