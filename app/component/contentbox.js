...
export default function ContentBoxSection() {
  return (
    <div className="bg-secondary w-full flex flex-col items-center pb-20 -mt-[125px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16 w-full max-w-7xl px-4 z-30">
        {contentBoxes.map((box, index) => (
          <div
            key={box.id}
            className={`group relative flex flex-col items-center bg-secondary p-12 rounded-lg shadow-lg transition-transform transform hover:-translate-y-${
          ...
          >
            ...
            <div className="mt-4 text-center">
              <h2 className="text-2xl font-bold text-black drop-shadow-3xl mb-2">{box.title}</h2>
